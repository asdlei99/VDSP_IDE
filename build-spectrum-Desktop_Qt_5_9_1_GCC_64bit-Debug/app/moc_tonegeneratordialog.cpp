...
#include "../../spectrum/app/tonegeneratordialog.h"
...
struct qt_meta_stringdata_ToneGeneratorDialog_t {
    QByteArrayData data[4];
    char stringdata0[51];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ToneGeneratorDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ToneGeneratorDialog_t qt_meta_stringdata_ToneGeneratorDialog = {
    {
QT_MOC_LITERAL(0, 0, 19), // "ToneGeneratorDialog"
QT_MOC_LITERAL(1, 20, 21), // "frequencySweepEnabled"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 7) // "enabled"

    },
    "ToneGeneratorDialog\0frequencySweepEnabled\0"
    "\0enabled"
};
...
const QMetaObject ToneGeneratorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ToneGeneratorDialog.data,
      qt_meta_data_ToneGeneratorDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *ToneGeneratorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ToneGeneratorDialog.stringdata0))
